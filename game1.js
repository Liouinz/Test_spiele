...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    a:hover { border-color: #4a90e2; color: #fff; }
  </style>
</head>
<body>

  <canvas id="canvas"></canvas>
  <!-- Schließt das Overlay im Parent-Fenster, falls im iframe geladen -->
  <a href="#" onclick="
    ...
    return false;
  ">← Zurück zum Launcher</a>

  <script>
    // ── Konfiguration ──
    const COLS       = 32;
    const ROWS       = 64;
    const CELL       = 10;          // Pixel pro Zelle
    const SPEED      = 3;           // Pixel pro Frame
    const PLAYER_SIZE = CELL - 2;   // leicht kleiner als Zelle
